                        ...
                        <form action="{{ route('admin.categories.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="description" name="description" value="{{ $data['description'] }}" class="@error('description') is-invalid @enderror">
                                    @error('description')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="color" name="color" value="{{ $data['color'] }}" class="@error('color') is-invalid @enderror">
                                    @error('color')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <img src="{{ $data['cover'] }}" alt="{{ $data['name'] }}" width="110" height="60">
