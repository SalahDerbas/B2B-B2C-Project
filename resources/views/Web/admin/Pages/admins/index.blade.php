    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="row">
                    <a href="{{ route('admin.admins.create') }}" class="btn btn-success text-center AddButtonC" >Add Admin</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdownMenuC" aria-labelledby="dropdownMenuButton" >
                                            <form action="{{ route('admin.admins.edit') }}" method="GET" class="formC" >
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.admins.switchStatus') }}" method="GET" class="formC" >
                                                @csrf
                                                <input id="id" type="hidden" name="id" class="form-control" value="{{ $item->id }}">
                                                <button type="submit" class="dropdown-item d-flex justify-content-between align-items-center">
