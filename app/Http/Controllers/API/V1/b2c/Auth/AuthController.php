...
namespace App\Http\Controllers\API\V1\b2c\Auth;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;
use Illuminate\Support\Facades\Auth;
use App\Http\Requests\API\V1\b2c\Auth\AuthRequest;
use App\Models\User;
use App\Jobs\API\V1\b2c\Auth\SendOTPEmailJob;
use Carbon\Carbon;
use App\Http\Resources\API\V1\b2c\Auth\UserResource;
    ...
    */
    public function register(AuthRequest $request)
    {
        try{
            ...
            return responseSuccess('' , getStatusText(REGISTER_USER_SUCCESS_CODE)  , REGISTER_USER_SUCCESS_CODE);
        } catch (\Exception $e) {
            return responseError($e->getMessage(), Response::HTTP_UNPROCESSABLE_ENTITY ,DATA_ERROR_CODE);
        }
    }
